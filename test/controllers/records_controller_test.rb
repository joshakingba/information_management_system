...
class RecordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create record" do
    assert_difference("Record.count") do
      post records_url, params: { record: { content: @record.content, title: @record.title } }
    end
  ...
  test "should update record" do
    patch record_url(@record), params: { record: { content: @record.content, title: @record.title } }
